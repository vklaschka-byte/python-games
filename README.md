...
| 20 | **Průzkumník bludiště** | Vizualizér algoritmů pro hledání cesty s využitím logiky BFS. | `algorithms`, `deque` |
---

## 🚀 RYCHLÝ START
Chcete mít přístup ke všem nástrojům z jednoho místa? Spusťte centrální konzoli:
